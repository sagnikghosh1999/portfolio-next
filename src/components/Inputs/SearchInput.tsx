...
const SearchInput: React.FC<SearchInputProps> = ({
  ...
  const combinedClassName = twMerge(
    `
      ...
      focus:border-blue-500 dark:focus:border-blue-900
      hover:border-blue-500 dark:hover:border-blue-800
      focus:outline-none
      rounded-xl
    ...
    <div className="relative w-full md:flex-grow md:order-last">
      ...
      >
        {localSearchTerm && (
          <X
            className="
            text-neutral-500 cursor-pointer hover:text-blue-500 dark:hover:text-blue-800 
